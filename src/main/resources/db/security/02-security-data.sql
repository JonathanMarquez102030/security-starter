...
INSERT INTO group_authorities (group_id, authority)
SELECT id, 'ROLE_PRUEBA' FROM groups WHERE group_name = 'ADMINISTRATORS'
ON CONFLICT (group_id, authority) DO NOTHING;
...
SELECT 'admin', id FROM groups WHERE group_name = 'ADMINISTRATORS'
ON CONFLICT (username, group_id) DO NOTHING;

INSERT INTO group_members (username, group_id)
SELECT 'user', id FROM groups WHERE group_name = 'USERS'
ON CONFLICT (username, group_id) DO NOTHING;